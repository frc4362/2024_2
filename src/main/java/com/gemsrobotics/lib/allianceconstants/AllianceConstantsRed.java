...
public class AllianceConstantsRed extends AllianceConstants {
    public static final Translation2d AMP_FEED_OFFSET = new Translation2d(-1.0, -0.33);
    ...
    public static final Translation2d RED_AMP_FEED_LOCATION_METERS = RED_AMP_METERS.plus(AMP_FEED_OFFSET);
    public static final Translation2d RED_MID_FEED_LOCATION_METERS = RED_AMP_FEED_LOCATION_METERS.plus(AMP_TO_MID_OFFSET);
