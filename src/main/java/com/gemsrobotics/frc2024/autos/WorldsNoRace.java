...
public class WorldsNoRace extends SequentialCommandGroup {
	private static final String AUTO_NAME = "Source 123 N";
	private static final String START_AUTO_NAME = "Source 123 1";
	public WorldsNoRace() {
//
//		final var drive = Swerve.getInstance();
//		final var start = drive.getTrackTrajectoryCommand(AUTO_NAME + " 1" + ".1", true);
...
//				drive.resetOdometryOnTrajectory(START_AUTO_NAME + ".1"),
//				new ShootNoteCommand(3.0, true),
